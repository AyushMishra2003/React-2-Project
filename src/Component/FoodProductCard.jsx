...
const FoodProductCard = ({image,Pname,Price,DPrice}) => {
  return (
    <div className='w-[17rem] flex flex-col items-center justify-center  md hover:shadow-[5px_10px_5px_#878386] p-[0.5rem] rounded-[0.5rem] gap-[0.5rem]  border border-black '>
