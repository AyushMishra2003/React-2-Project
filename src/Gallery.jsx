    ...
    <div className='flex flex-col gap-[4rem] items-center pt-[4rem] '>
      <div className=''>
        ...
        <div className='flex flex-col lg:flex-row lg:items-center lg:gap-[18rem] xl:gap-[26rem] '>
           ...
           <button className='w-fit h-[3rem] px-[1.3rem] rounded-[0.3rem] bg-[#4BAF47] text-white border  border-[#4BAF47] hover:bg-white hover:text-black ease-in duration-500'>Discover More</button>
        </div>
        </div>
